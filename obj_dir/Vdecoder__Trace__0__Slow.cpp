...
VL_ATTR_COLD void Vdecoder___024root__trace_init_sub__TOP__0(Vdecoder___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    VL_TRACE_DECL_BUS(tracep,c+0,0,"a",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, 1,0);
    VL_TRACE_DECL_BIT(tracep,c+1,0,"en",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC);
    ...
    VL_TRACE_DECL_BUS(tracep,c+0,0,"a",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, 1,0);
    VL_TRACE_DECL_BIT(tracep,c+1,0,"en",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC);
...
VL_ATTR_COLD void Vdecoder___024root__trace_register(Vdecoder___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    tracep->addConstCb(&Vdecoder___024root__trace_const_0, 0, vlSelf);
    tracep->addFullCb(&Vdecoder___024root__trace_full_0, 0, vlSelf);
    tracep->addChgCb(&Vdecoder___024root__trace_chg_0, 0, vlSelf);
...
VL_ATTR_COLD void Vdecoder___024root__trace_full_0_sub_0(Vdecoder___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+0,(vlSelfRef.tb__DOT__a),2);
    bufp->fullBit(oldp+1,(vlSelfRef.tb__DOT__en));
